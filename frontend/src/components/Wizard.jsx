...
import { ArrowLeft, ArrowRight, Check, Sparkles, X, BookOpen, User, Volume2, AlignLeft } from 'lucide-react';
              ...
              {currentStep === 3 && (
                <div className="space-y-4">
                  ...
                  <p className="text-slate-400 text-xs">
                    Paste up to 8,000 characters of facts, raw data or URLs. The Gemini agent uses this to minimize hallucinations.
                  </p>
                  <div>
